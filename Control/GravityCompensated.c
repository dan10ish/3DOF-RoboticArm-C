...
void calculateControlTorques(const RobotState *state, double *tau)
{
    ...
    double C112 = -((1.0 / 3.0) * m2 * pow(a2, 2) * sin(2 * q2) + m3 * pow(a2, 2) * sin(q2) +
                    (1.0 / 3.0) * m3 * pow(a3, 2) * sin(2 * (q2 + q3)) + m3 * a2 * a3 * sin(2 * q2 + q3));
    double C113 = -((1.0 / 2.0) * m3 * a2 * a3 * sin(q3) + (1.0 / 3.0) * m3 * pow(a3, 2) * sin(2 * (q2 + q3)) +
                    (1.0 / 2.0) * m3 * a2 * a3 * sin(2 * q2 + q3));
    double C211 = ((1.0 / 6.0) * m2 * pow(a2, 2) + (1.0 / 2.0) * m3 * pow(a3, 2)) * sin(2 * q2) +
                  (1.0 / 6.0) * m3 * pow(a3, 2) * sin(2 * (q2 + q3)) + (1.0 / 2.0) * m3 * a2 * a3 * sin(2 * q2 + q3);
    double C223 = -(m3 * a2 * a3 * sin(q3));
    double C233 = -(1.0 / 2.0) * m2 * a2 * a3 * sin(q3);
    double C311 = (1.0 / 6.0) * m3 * pow(a3, 2) * sin(2 * (q2 + q3)) + (1.0 / 4.0) * m3 * a2 * a3 * sin(q3) +
