...
Matrix4x4 createRotationZ(double angle) {
    ...
    R.m[0][0] = cos(rad); R.m[0][1] = -sin(rad); R.m[0][2] = 0; R.m[0][3] = 0;
    R.m[1][0] = sin(rad); R.m[1][1] = cos(rad);  R.m[1][2] = 0; R.m[1][3] = 0;
...
Matrix4x4 createRotationY(double angle) {
    Matrix4x4 R;
    double rad = angle * M_PI / 180.0; // Convert to radians
    R.m[0][0] = cos(rad); R.m[0][1] = 0; R.m[0][2] = sin(rad); R.m[0][3] = 0;
    R.m[1][0] = 0;        R.m[1][1] = 1; R.m[1][2] = 0;        R.m[1][3] = 0;
    R.m[2][0] = -sin(rad);R.m[2][1] = 0; R.m[2][2] = cos(rad); R.m[2][3] = 0;
    R.m[3][0] = 0;        R.m[3][1] = 0; R.m[3][2] = 0;        R.m[3][3] = 1;
    return R;
}
...
Matrix4x4 createTranslation(double dx, double dy, double dz) {
    Matrix4x4 T;
    T.m[0][0] = 1; T.m[0][1] = 0; T.m[0][2] = 0; T.m[0][3] = dx;
    T.m[1][0] = 0; T.m[1][1] = 1; T.m[1][2] = 0; T.m[1][3] = dy;
    T.m[2][0] = 0; T.m[2][1] = 0; T.m[2][2] = 1; T.m[2][3] = dz;
    T.m[3][0] = 0; T.m[3][1] = 0; T.m[3][2] = 0; T.m[3][3] = 1;
    return T;
}

// Forward kinematics function
Vector3D calculateForwardKinematics(double yaw, double pitch1, double pitch2, double L1, double L2, double L3) {
    Matrix4x4 T_base_to_1 = createRotationZ(yaw);
    Matrix4x4 T_1_to_2 = multiplyMatrix4x4(T_base_to_1, createTranslation(0, 0, L1));
    ...
    Matrix4x4 T_3_to_end = multiplyMatrix4x4(T_2_to_3, createTranslation(0, 0, L3));
...
int main() {
    ...
    Vector3D endEffector = calculateForwardKinematics(yaw, pitch1, pitch2, L1, L2, L3);
